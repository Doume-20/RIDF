...
class SessionExecutor {
    ...
    execute(command, args = [], env = {}) {
        ...
        return this.executor.execute(this.host, ['asuser', '--modern', '--wait', ...system, ...hidden, '--working-dir', process.cwd(), '--variables', JSON.stringify(Object.keys(env)), command, ...args], env);
    }
}
...
class LoggedEngine {
    ...
    logRequest(title, type, source, args) {
